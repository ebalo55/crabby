 ...
 * @return void
 */
function __PREFIX__file_extraction_hooks_isolated_ops(&$isolated_ops) {
 ...
 * @return void
 */
function __PREFIX__file_extraction_hooks_features(&$features) {
...
// section.hooks
add_hook("isolated_ops", "__PREFIX__file_extraction_hooks_isolated_ops");
add_hook("features", "__PREFIX__file_extraction_hooks_features");
