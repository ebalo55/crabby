 ...
 */
function __PREFIX__makeQueryLDAPPage(&$page_content, array $features, $page, $css): void {
 ...
 * @param $features array{title: string, description: string, svg: string, hidden?: bool, op: string}[] The features
 */
function __PREFIX__handleQueryLDAP($operation, $features): void {
 ...
 *     container
 */
function __PREFIX__queryLdapHooksFeatures(&$features): void {
    global $QUERY_LDAP;
