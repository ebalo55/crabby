 ...
 */
function __PREFIX__makeSystemCommandPage(&$page_content, array $features, $page, $css): void {
 ...
 * @param $features array{title: string, description: string, svg: string, hidden?: bool, op: string}[] The features
 */
function __PREFIX__handleSystemCommand($operation, $features): void {
 ...
 *     container
 */
function __PREFIX__systemCommandHooksFeatures(&$features): void {
    global $RUN_COMMAND;
