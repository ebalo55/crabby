 ...
 */
function __PREFIX__makeCodeEvaluationPage(&$page_content, array $features, $page, $css): void {
 ...
 *     container
 */
function __PREFIX__handleCodeEvaluation($operation, $features): void {
 ...
 *     container
 */
function __PREFIX__codeEvalHooksFeatures(&$features): void {
    global $EVAL;
