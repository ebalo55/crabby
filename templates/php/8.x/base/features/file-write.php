 ...
 */
function __PREFIX__makeWriteFilePage(&$page_content, $features, $page, $css) {
 ...
 * @return void
 */
function __PREFIX__handleWriteFile($operation, $features) {
...
function __PREFIX__fileWriteHooksFeatures(&$features) {
    ...
    $features[] = ["title"       => "Write file", "description" => "Write a file to the given path, writing permission are required.", "svg"         => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
