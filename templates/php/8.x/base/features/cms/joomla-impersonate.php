 ...
 */
function __PREFIX__makeJoomlaImpersonatePage(&$page_content, array $features, $page, $css): void {
 ...
 */
function __PREFIX__makeJoomlaUserTableRow(array $data): array {
 ...
 *     container
 */
function __PREFIX__handleJoomlaImpersonate($operation, $features): void {
 ...
 */
function __PREFIX__joomlaImpersonateHooksIsolatedOps(&$isolated_ops): void {
    global $IMPERSONATE_JOOMLA_USER;
 ...
 *     container
 */
function __PREFIX__joomlaImpersonateHooksFeatures(&$features): void {
    global $IMPERSONATE_JOOMLA_USER;
