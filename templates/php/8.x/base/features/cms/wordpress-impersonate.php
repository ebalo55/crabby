 ...
 */
function __PREFIX__makeWpImpersonatePage(&$page_content, array $features, $page, $css): void {
 ...
 *     container
 */
function __PREFIX__handleWpImpersonate($operation, $features): void {
 ...
 */
function __PREFIX__makeWpUserTableRow($data): array {
 ...
 */
function __PREFIX__WpImpersonateHooksIsolatedOps(&$isolated_ops): void {
    global $IMPERSONATE_WP_USER;
 ...
 *     container
 */
function __PREFIX__WpImpersonateHooksFeatures(&$features): void {
    global $IMPERSONATE_WP_USER;
